...
missclassification rates for the `r k` models:
...
Based on the data, the final model selected is the `r best_idx`th forest which has
both low missclassification rate and low OOB error. The estimated OOB error
for this model is `r round(ov[best_idx], 5)`.
